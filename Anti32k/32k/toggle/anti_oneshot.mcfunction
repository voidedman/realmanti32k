...
execute @s[tag=stafftag,scores={OSM=1}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cHydraAnti32k §¶§b→ §6Anti-Oneshot §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
...
execute @s[tag=stafftag,scores={OSM=2}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cHydraAnti32k §¶§b→ §6Anti-Oneshot §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
execute @s[tag=stafftag,scores={OSM=2}] ~~~ scoreboard players set osmtoggledummy OSM 0
#Deny Nonstaff
execute @s[tag=!stafftag] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cHydraAnti32k §¶§b→ Access §cDENIED§7! §bOnly staff can use this command"}]}
